...
macro_rules! sensor_definition {
    ...
    SensorCorticalType {
        Infrared => {
            ...
            base_ascii: b"iinf00",
            channel_dimensions: SingleChannelDimensionRange::new(1..2, 1..2, 1..2),
        ...
        VisionCenterGray => {
            ...
            base_ascii: b"ivcc00",
            channel_dimensions: SingleChannelDimensionRange::new(1..u32::MAX, 1..u32::MAX, 1..2),
        ...
        VisionCenterColor => {
            ...
            base_ascii: b"iVcc00",
            channel_dimensions: SingleChannelDimensionRange::new(1..u32::MAX, 1..u32::MAX, 1..5),
            io_variants: [IOTypeVariant::ImageFrame, IOTypeVariant::SegmentedImageFrame],
            encoder_type: NeuronCoderVariantType::ImageFrame,
        },
        VisionTopLeftColor => {
