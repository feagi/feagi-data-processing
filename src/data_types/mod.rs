...
impl LinearBoundedF32 {
    ...
    pub fn new_with_clamp(value: f32, upper_bound: f32, lower_bound: f32) -> Result<Self, DataProcessingError> {
        Self::validate_bounds(upper_bound, lower_bound)?;
        validate_float_is_real(value)?;
    ...
    pub fn new_from_normalized(value: RangedNormalizedF32, upper_bound: f32, lower_bound: f32) -> Result<Self, DataProcessingError> {
        Self::validate_bounds(upper_bound, lower_bound)?;
    ...
    pub fn as_normalized_f32(&self) -> RangedNormalizedF32 {
    ...
    pub fn update_value(&mut self, new_value: f32) -> Result<(), DataProcessingError> {
    ...
    pub fn update_bounds(&mut self, upper_bound: f32, lower_bound: f32) -> Result<(), DataProcessingError> {
        Self::validate_bounds( upper_bound, lower_bound)?;
        if self.value > upper_bound {
            return Err(DataProcessingError::InvalidInputBounds("Upper bound may not be smaller than the current value!".into()));
        }
        if self.value < lower_bound {
            return Err(DataProcessingError::InvalidInputBounds("Lower bound may not be larger than the current value!".into()));
        }
    ...
    fn validate_value_bounds(value: f32, upper: f32, lower: f32)  -> Result<(), DataProcessingError> {
        if value > upper {
            return Err(DataProcessingError::InvalidInputBounds("Value may not be Greater than upper bound!".into()));
        }
        if value < lower {
            return Err(DataProcessingError::InvalidInputBounds("Value may not be Less than lower bound!".into()));
        }
        Ok(())
    }
    ...
    fn validate_bounds(upper: f32, lower: f32) -> Result<(), DataProcessingError> {
        validate_float_is_real(upper)?;
        validate_float_is_real(lower)?;
        if lower >= upper {
            return Err(DataProcessingError::InvalidInputBounds("Lower bound may not be greater than the upper!".into()));
        }
        Ok(())
    }
...
impl RangedNormalizedF32 {
    pub fn new(float: f32) -> Result<Self, DataProcessingError> {
        ...
        RangedNormalizedF32::validate_float_range(float)?;
        Ok(Self { float })
    }
    ...
    pub fn update(&mut self, new_float: f32) -> Result<(), DataProcessingError> {
        ...
        RangedNormalizedF32::validate_float_range(new_float)?;
    ...
    fn validate_float_range(float: f32) -> Result<(), DataProcessingError> {
...
fn validate_float_is_real(value: f32) -> Result<(), DataProcessingError> {
    if value.is_nan() {
        return Err(DataProcessingError::InvalidInputBounds("Value may not be NaN!".into()));
    }
    if value.is_infinite() {
        return Err(DataProcessingError::InvalidInputBounds("Value may not be Infinite!".into()));
    }
    Ok(())
}
