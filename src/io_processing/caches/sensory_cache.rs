...
use crate::io_data::{ImageFrame, ImageFrameTransformerDefinition};
...
impl SensorCache {
    ...
    pub fn register_cortical_group_for_image_camera_with_peripheral(&mut self, cortical_group: CorticalGroupingIndex,
                                                                    allow_stale_data: bool,
                                                                    input_image_properties: ImageFrameProperties,
                                                                    segmentation_center_properties: SegmentedFrameCenterProperties) -> Result<(), FeagiDataProcessingError> {
    ...
    fn register_cortical_area_image_frame(&mut self, sensor_cortical_type: SensorCorticalType, 
        ...
        let image_transformer_definition = ImageFrameTransformerDefinition::new_from_input_output_properties(&input_image_properties, &output_image_properties)?;
